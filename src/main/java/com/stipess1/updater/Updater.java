...
import xyz.ufactions.customcrates.exception.PrimaryThreadException;
...
public class Updater {
     ...
     * @see Result
     */
    public Result getResult() throws PrimaryThreadException {
        waitThread();
        return result;
    }
     ...
     */
    public String getVersion() throws PrimaryThreadException {
        waitThread();
        return version;
    }
     ...
     */
    private void waitThread() throws PrimaryThreadException {
        if (Bukkit.getServer().isPrimaryThread()) {
            throw new PrimaryThreadException("Cannot wait for thread on primary thread.");
        }
