...
public class InfoCommand extends SubCommand {
    ...
    protected boolean execute(CommandSender sender, String label, String[] args) {
        ...
        sender.sendMessage(F.format("Author: &e" + F.concatenate(", ", pdf.getAuthors())));
        sender.sendMessage(F.format("Version: &e" + pdf.getVersion()));
        sender.sendMessage(F.format("Description: &e" + pdf.getDescription()));
        return true;
    }
